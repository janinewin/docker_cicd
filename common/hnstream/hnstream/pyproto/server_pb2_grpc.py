...
def add_HnstreamerServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'hnstream.Hnstreamer', rpc_method_handlers)
...
class Hnstreamer(object):
    ...
    def GetNextComments(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/hnstream.Hnstreamer/GetNextComments',
    ...
    def GetNextStories(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/hnstream.Hnstreamer/GetNextStories',
            server__pb2.GetNextRequest.SerializeToString,
