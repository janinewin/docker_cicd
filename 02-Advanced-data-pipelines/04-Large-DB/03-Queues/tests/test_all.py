...
def test_docker_compose():
    ...
    assert lewagonde.docker_compose_equal(dc_path, dc_correction_path), "Incorrect Docker Compose"
...
def test_simple_callback(capsys):
    ...
    assert "Received" in captured_stdout and "hello" in captured_stdout, "print_callback should print 'Received' + the body"
