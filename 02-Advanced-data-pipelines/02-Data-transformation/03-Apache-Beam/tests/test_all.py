...
def test_txt_file_exists():
    ...
    assert os.path.isfile(txt_fp), "Please download the file https://storage.googleapis.com/lewagon-data-engineering-bootcamp-assets/datasets/data-engineering-cookbook-book/The_Data_Engineering_Cookbook.txt under ./data/"
