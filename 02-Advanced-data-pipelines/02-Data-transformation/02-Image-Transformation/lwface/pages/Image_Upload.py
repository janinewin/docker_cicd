...
def uploaded_file_to_image_ndarray(file: st.uploaded_file_manager.UploadedFile) -> np.ndarray:
    """
...
def apply_face_patches_to_original_image(img: np.ndarray, face_patches: List[Patch]) -> Image:
    """
