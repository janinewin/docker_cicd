...
# current_file = '/Users/nicolasbancel/git/lewagon/data-engineering-solutions/02-Advanced-data-pipelines/01-ELT-DBT/04-DBT-Optimization-Optional/tests/test_dbt_variable.py'
...
dbt_project_path = pathlib.Path(os.path.join(challenge_level_dir, "dbt_lewagon/dbt_project.yml"))
