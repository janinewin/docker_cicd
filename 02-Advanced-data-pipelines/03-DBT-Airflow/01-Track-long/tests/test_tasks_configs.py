...
class TestTasksConfigs:
    ...
    def test_tasks(self):
        ...
        bash_command_by_task_name = {
            "model.dbt_lewagon.my_first_dbt_model": f"{dbt_no_write} run --models my_first_dbt_model {dir_locations}",
            "model.dbt_lewagon.my_second_dbt_model": f"{dbt_no_write} run --models my_second_dbt_model {dir_locations}",
            "test.dbt_lewagon.unique_my_first_dbt_model_id": f"{dbt_no_write} test --models unique_my_first_dbt_model_id {dir_locations}",
            "test.dbt_lewagon.not_null_my_first_dbt_model_id": f"{dbt_no_write} test --models not_null_my_first_dbt_model_id {dir_locations}",
            "test.dbt_lewagon.unique_my_second_dbt_model_id": f"{dbt_no_write} test --models unique_my_second_dbt_model_id {dir_locations}",
            "test.dbt_lewagon.not_null_my_second_dbt_model_id": f"{dbt_no_write} test --models not_null_my_second_dbt_model_id {dir_locations}",
        }
