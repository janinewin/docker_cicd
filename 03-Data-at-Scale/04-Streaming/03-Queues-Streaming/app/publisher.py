...
def get_message_data(sensor_name: str, sensor_center_line: float, sensor_standard_deviation: float) -> str:
...
def run(topic_name: str, project_id: str):
    ...
    while True:
        ...
        for i in range(len(sensor_names)):
            ...
            message = get_message_data(sensor_names[i], sensor_center_lines[i], standard_deviations[i])
