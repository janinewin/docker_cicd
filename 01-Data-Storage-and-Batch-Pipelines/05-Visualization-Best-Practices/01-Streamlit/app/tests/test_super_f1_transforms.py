...
class TestSuperF1Transforms:
    ...
    def testBestTimePerLap(self, lap_times_for_race_989_dataFrame, best_lap_times_for_race_989_dataFrame):
        assert TestF1Transforms().testGetBestTimePerLap(lap_times_for_race_989_dataFrame, best_lap_times_for_race_989_dataFrame) == best_lap_times_for_race_989_dataFrame
